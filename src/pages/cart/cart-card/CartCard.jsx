...
import { AiFillEye, AiFillHeart, AiFillMinusCircle, AiFillPlusCircle } from "react-icons/ai";
import { Link } from "react-router-dom";
import { useAuth } from "../../../context/authContext";
import { useCart } from "../../../context/cartContext";
import "./cart-card.css"
export const CartCard = ({product : {_id, title, image, price, originalPrice, trending, qty}}) => {
    const { token } = useAuth();
    const {
      dispatch,
    } = useCart();
